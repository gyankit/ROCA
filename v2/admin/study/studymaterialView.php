...
if( $_SERVER["REQUEST_METHOD"] == "POST" )
{
	if( isset($_POST["delete"]) ) {
		$delete = $_POST["delete"];	
		$id = explode(',', $delete);
		if( !$confirm = $study->deletestudymaterial($id[0], $id[1]) ) {
										...
										<tr>
											...
											<td>
												<form method="post" action="">
													<button type="submit" class="btn-sm btn-danger font-weight-bold" name="delete" value="<?php echo $data['id'].",".$data['material']; ?>"> Delete </button>
												</form>
											</td>
										</tr>
