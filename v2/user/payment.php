...
if($_REQUEST['email']=="" or $_REQUEST['cost']=="" or $_REQUEST['event']=="" or $_REQUEST['eid']=="" )
{
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    elseif($home->updateparticipation($mode, $transaction, $email, $eid)) {
        ?><script>
