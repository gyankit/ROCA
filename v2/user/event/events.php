	...
	<div class="">
			...
			<div class="container">
				<div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
					<div class="col-md-8 text-center">
						<p class="breadcrumbs"><span class="mr-2"><a  href="../home/home">Home</a></span> <span>Events</span></p>
						...
						<div class="blog-entry align-self-stretch">
							...
							<div class="text p-4 d-block">
								...
								<h3 class="heading mb-4">
									<a <?php if($data2['link']==1) { if($data2['event']=="All") { ?> href="eventregistration?id=<?= $data2['id']; ?>" <?php } else { ?> href="../login/login" <?php } } else { ?> href="#" <?php } ?>><?= $data2['heading']; ?></a>
								</h3>
								...
								<?php if($data2['link']==1) { ?>
									<p><a <?php if($data2['event']=="All") { ?> href="eventregistration?id=<?= $data2['id']; ?>" <?php } else { ?> href="../login/login" <?php } ?>>Join Event <i class="ion-ios-arrow-forward"></i></a></p>
								<?php } ?>
							</div>
						</div>
					</div>
		...
		<section class="ftco-section">
      		<div class="container">
				...
				<?php if(!$view) { echo "<p class='text-center'>Upcomming Events List Not Available</p>"; } else {  ?>
					...
					<div class="col-md-4 d-flex">
						<div class="blog-entry align-self-stretch">
							...
							<div class="text p-4 d-block">
								...
								<h3 class="heading mb-4">
									<a <?php if($data['link']==1) { if($data['event']=="All") { ?> href="eventregistration?id=<?= $data['id']; ?>" <?php } else { ?> href="../login/login" <?php } } else { ?> href="#" <?php } ?>><?= $data['heading']; ?></a>
								</h3>
								...
								<?php if($data['link']==1) { ?>
									<p><a <?php if($data['event']=="All") { ?> href="eventregistration?id=<?= $data['id']; ?>" <?php } else { ?> href="../login/login" <?php } ?>>Join Event <i class="ion-ios-arrow-forward"></i></a></p>
								<?php } ?>
							</div>
						</div>
					</div>
		...
		<section class="ftco-section">
      		<div class="container">
				...
				<?php if(!$view1) { echo "<p class='text-center'>Recent Events List Not Available</p>"; } else { ?>
