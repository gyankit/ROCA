        ...
        <div class="row mb-5">
            ...
            <div class="col-md-3">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        ...
                        <li><a href="https://www.youtube.com/channel/UCzq3qrhy1iqaBPSEQhwSRpg" target="_blank"><span class="icon icon-youtube-play"></span></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="register/register" class="py-2 d-block">Register</a></li>
