...
<body>
	...
	<div class="jumbotron-fluid">
			...
			<div class="alert">
				...
				<button class="btn btn-danger btn-lg float-right col-5"><a class="text-white font-weight-bold text-capitalize" href="deleteadmin.php?id=<?php echo $id;?>&role=<?php echo $role;?>">Delete</a></button>
			</div>
			<div class="alert"></div>
		</div>
	</div>
