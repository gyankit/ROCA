<?php 
	...
	{
		$sql1="CREATE TABLE `id8469611_clubroca`.`studymaterial_tbl` ( `id` INT(10) NOT NULL AUTO_INCREMENT , `department` VARCHAR(3) NOT NULL , `year` VARCHAR(3) NOT NULL , `semester` VARCHAR(3) NOT NULL , `code` VARCHAR(10) NOT NULL , `subject` VARCHAR(100) NOT NULL , `topic` VARCHAR(100) NOT NULL , `material` TEXT NOT NULL , PRIMARY KEY (`id`))";
